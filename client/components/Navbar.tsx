...
export const Navbar = () => {
  ...
  const { openMyAccount }         = useSubscription();
          ...
          <div className="flex items-center justify-between h-16 md:h-18">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="hidden md:flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
              >
            ...
            >
              <div className="px-4 py-4 space-y-1">
                ...
                <div className="pt-3 border-t border-white/10 flex gap-2">
                  <button
                    onClick={() => { openMyAccount(); setIsOpen(false); }}
                    className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-white/10 hover:bg-white/20 text-white text-sm font-semibold rounded-xl transition-all"
                  >
                    <User className="w-4 h-4" />
                    Mon compte
                  </button>
